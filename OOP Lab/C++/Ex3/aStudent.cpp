...
main()
{
    ...
    char cControl;
    int nSeat;
    cout<<"Enter the Total No. of Seats Available for the Students: ";
    cin>>nSeat;
    CStudent::AssignTotalSeats(nSeat);
    cout<<"Enter the Total No. of Waiting List Available for the Students: ";
    cin>>nSeat;
