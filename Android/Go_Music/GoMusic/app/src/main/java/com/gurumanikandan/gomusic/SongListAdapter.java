...
public class SongListAdapter extends ArrayAdapter<String> {
    ...
    public SongListAdapter(@NonNull Context context, @NonNull ArrayList<String> album, ArrayList<Bitmap> bitmaps) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if(convertView == null)
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.song_row_layout, parent, false);
